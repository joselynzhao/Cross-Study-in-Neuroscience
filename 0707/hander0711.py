...
# https://blog.csdn.net/cxu123321/article/details/101000604
        ...
        outfile.write(' '.join(map(str,[p1,p2,time_s,time_e,top_value,top_index,amp,slope_90_10,t_half,auc,a,b,c]))+'\n')
        # print(
        ...
        plt.plot(x2,[self.__get_tau(i-top_index,a,b,c) for i in x2])
