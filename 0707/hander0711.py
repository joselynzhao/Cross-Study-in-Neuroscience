...
class Hander_index():
    ...
    def get_paras_for_mountain(self, p1, p2):
        ...
        half_left = self.__get_near_index(half_top,p1,top_index)
        half_right = self.__get_near_index(half_top,top_index,p2)
        ...
        right_amp_90_index = self.__get_near_index(right_amp_90,top_index,right_blow_index)
        right_amp_10_index = self.__get_near_index(right_amp_10,top_index,right_blow_index)
...
# https://blog.csdn.net/cxu123321/article/details/101000604
        x = np.array(range(right_amp_90_index,right_amp_10_index,1))
